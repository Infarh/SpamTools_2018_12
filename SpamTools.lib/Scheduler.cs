        ...
        public Scheduler()
        {
            _Tasks = new ObservableCollection<SchedulerTask>
            {
                new SchedulerTask
                {
                    ...
                    Recipients = new[]
                    {
                        new EmailRecipient { Id = 0, Name = "Resipient 1", EmailAddress = "recipient1@mail.ru"},
                        new EmailRecipient { Id = 1, Name = "Resipient 2", EmailAddress = "recipient2@mail.ru"},
                        new EmailRecipient { Id = 2, Name = "Resipient 3", EmailAddress = "recipient3@mail.ru"}
                    },
